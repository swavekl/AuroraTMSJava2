...
public class BracketGeneratorTest {
    ...
    public void test2 () {
        ...
        assertEquals (2, bracketLines.length, "wrong size");
    ...
    public void test4 () {
        ...
        BracketLine[] bracketLines = bracketGenerator.generateBracket();
        assertEquals (4, bracketLines.length, "wrong size");
    ...
    public void test8 () {
        ...
        BracketLine[] bracketLines = bracketGenerator.generateBracket();
        assertEquals (8, bracketLines.length, "wrong size");
    ...
    public void test16 () {
        ...
        BracketLine[] bracketLines = bracketGenerator.generateBracket();
        assertEquals (16, bracketLines.length, "wrong size");
    ...
    public void test32 () {
        ...
        BracketLine[] bracketLines = bracketGenerator.generateBracket();
        assertEquals (32, bracketLines.length, "wrong size");
    ...
    public void test64 () {
        ...
        BracketLine[] bracketLines = bracketGenerator.generateBracket();
        assertEquals (64, bracketLines.length, "wrong size");
    ...
    private void checkByes(BracketLine[] bracketLines, int[] expectedByes) {
        for (int i = 0; i < bracketLines.length; i++) {
            ...
            if (expectedBye != 0) {
                assertTrue(bracketLine.isBye, "wrong bye");
                assertEquals(expectedBye, bracketLine.byeSeedNumber, "wrong bye num on line " + (i + 1));
            } else {
                assertFalse(bracketLine.isBye, "wrong bye");
            }
        }
    }
    ...
    private void checkDrawLines(BracketLine[] bracketLines, int[] expectedLineNumbers) {
        for (int i = 0; i < bracketLines.length; i++) {
            ...
            assertEquals(expectedLineNum, bracketLine.normalizedSeedNumber, "wrong line num");
        }
    }
}
